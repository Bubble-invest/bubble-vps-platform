...
Telegram alerts on conflict: same pattern as the Mac-side script + the Telegram-watchdog. Direct curl, captures bot token from env, posts to Joris's chat ID.
