...
DASHBOARD URL:
    Hardcoded for v1 to http://{{INTERNAL_IP}}:3848/heartbeat — the tailnet
    IP of {{VPS_HOST}} (where the dashboard lives, see tasks/monitoring/dashboard.py).
...
_DASHBOARD_URL_V1 = "http://{{INTERNAL_IP}}:3848/heartbeat"
